...
final class TravelData: ObservableObject {
    @Published var travel: Travel = Travel(isExist: false, name: "여행", startDate: Date(), endDate: Date(), users: [User(name: "오션", myRole: Role.defaultRoles[0], toDoList: ToDoList.defaultToDo)], usingRoles: [], travelCode: "3BF67A")
    //myRole: Role.defaultRoles[0]
